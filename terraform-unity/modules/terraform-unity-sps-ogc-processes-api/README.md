...
| <a name="input_db_secret_version"></a> [db\_secret\_version](#input\_db\_secret\_version) | The version of the database secret in AWS Secrets Manager | `string` | n/a | yes |
